...
public class DailyTaskRestController {
    ...
    @GetMapping
    public ResponseEntity<List<TaskListResponse>> findAll(@RequestParam(defaultValue = "") String search){
        return new ResponseEntity<>(dailyTaskService.findAll(search), HttpStatus.OK);
    }
